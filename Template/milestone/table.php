<?php if (!empty($milestone)): ?>
    <table class="task-links-table table-stripped table-scrolling">
        <thead id="thead-milestone-table">
            <tr>
                <th>
                    <?= t('Project') ?> <span class="order-by"><span>
                </th>
                <th>
                    <?= t('Column') ?> <span class="order-by"><span>
                </th>
                <th class="column-40">
                    <?= t('Title') ?> <span class="order-by"><span>
                </th>
                <th class="column-15">
                    <?= t('Assignee') ?> <span class="order-by"><span>
                </th>
                <th>
                    <?= t('Time tracking') ?>
                </th>
                ...
                <tr>
                    ...
                    <td>
                        <?php if (!empty($link['task_time_spent'])): ?>
                            <strong>
                                <?= $this->text->e($link['task_time_spent']) . 'h' ?>
                            </strong>
                            <?= t('spent') ?>
                        <?php endif ?>
                        ...
                        <?php if (!empty($link['task_time_estimated'])): ?>
                            <strong>
                                <?= $this->text->e($link['task_time_estimated']) . 'h' ?>
                            </strong>
                            <?= t('estimated') ?>
                        <?php endif ?>
                    ...
                    <?php if ($editable): ?>
                        <td>
                            <div class="dropdown">
                                <a href="#" class="dropdown-menu dropdown-menu-link-icon"><i class="fa fa-cog fa-fw"></i><i
            ...
            <tr>
                ...
                <td<?php if ($editable): ?> colspan="2" <?php endif ?>>
                    <div class="progress-bar">
                        ...
                        <div class="task-board progress color-<?= $task['color_id'] ?>"
                            style="width:<?= min(99, $percentage) ?>%;">
                            &#160;
                            <?= $percentage ?>%
                        </div>
                    </div>
                ...
                <tr>
                    ...
                    <td<?php if ($editable): ?> colspan="2" <?php endif ?>>
                        ...
                        <?php if (!empty($total_time_spent)): ?>
                            <strong>
                                <?= $this->text->e($total_time_spent) . 'h' ?>
                            </strong>
                            <?= t('spent') ?>
                        <?php endif ?>
                        ...
                        <?php if (!empty($total_time_estimated)): ?>
                            <strong>
                                <?= $this->text->e($total_time_estimated) . 'h' ?>
                            </strong>
                            <?= t('estimated') ?>
                        <?php endif ?>
                        ...
                        <?php if (!empty($total_time_spent) && !empty($total_time_estimated)): ?>
                            <strong>
                                <?= $this->text->e($total_time_estimated - $total_time_spent) . 'h' ?>
                            </strong>
                            <?= t('remaining') ?>
                        <?php endif ?>
